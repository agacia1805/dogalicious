...
function getICON(icon) {
 switch (icon) {
     ...
     case iconValue.Bullterrier_mini:
         return "img/dog breeds/bullterrier.png";
     case iconValue.Cane_corso:
         return "img/dog breeds/Cane-Corso.png";
     ...
     case iconValue.Irish_wolfhound:
         return "img/dog breeds/Irish-Wolfhound.png";
     ...
     case iconValue.Papillon:
         return "img/dog breeds/Papillon.png";
     ...
     case iconValue.Samoyed:
         return "img/dog breeds/Samoyed.png";
     ...
     case iconValue.Welsh_spaniel:
         return "img/dog breeds/english-cocker-spaniel.png";
     case iconValue.Whippet:
         return "img/dog breeds/Whippet.png";
